...
import com.springboot.security.dao.SRoleVODao;
        ...
        for (String auth:query){
            ...
            if (list1 != null && list.size()>0){
                for (Map<String,Object> map:list1){
                    Object value=map.get("resourceUrl");
            ...
            /**
             * 1.判断资源文件和权限的对应关系
             * 2.如果已经存在相关的资源url，则要通过该url为key提取出权限集合，将权限增加到权限集合中
             */
